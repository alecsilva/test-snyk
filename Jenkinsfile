pipeline {
    ...
    stages {
        stage('Snyk Open Source Scan - SCA') {
            catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') { snykSecurity additionalArguments: '-debug', failOnIssues: false, failOnError: false, monitorProjectOnBuild: true, 
